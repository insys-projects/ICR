// IcrAdp201cP5Dlg.cpp : implementation file
//
...
// CIcrAdp201cP5Dlg dialog

IMPLEMENT_DYNAMIC(CIcrAdp201cP5Dlg, CDialog)
CIcrAdp201cP5Dlg::CIcrAdp201cP5Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIcrAdp201cP5Dlg::IDD, pParent)
{
	m_BusClock = 100.0;
	m_HostPldCnt = 0;
	m_strPldName = _T("");
...
CIcrAdp201cP5Dlg::~CIcrAdp201cP5Dlg()
{
}

void CIcrAdp201cP5Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CIcrAdp201cP5Dlg, CDialog)
	ON_WM_DESTROY()
...
// CIcrAdp201cP5Dlg message handlers

BOOL CIcrAdp201cP5Dlg::OnInitDialog()
{
...
//	m_strSDRCON = buf;
	...
	SetMaskOnCheckBoxesJ(m_JMask, IDC_J3); 
...
BOOL CIcrAdp201cP5Dlg::PreTranslateMessage(MSG* pMsg)
{
...
void CIcrAdp201cP5Dlg::OnDestroy()
{
	CDialog::OnDestroy();
...
//	m_SDRCON = (USHORT)strtol(m_strSDRCON.GetBuffer(10), &stopstring, 16 );
	...
	GetMaskOnCheckBoxesJ(m_JMask, IDC_J3);
...
void CIcrAdp201cP5Dlg::OnCbnSelchangePldrate()
{
...
void CIcrAdp201cP5Dlg::OnCbnSelchangePldtype()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
//void CIcrAdp201cP5Dlg::OnEnKillfocusPldnum()
//{
//	// TODO: Add your control notification handler code here
//}

void CIcrAdp201cP5Dlg::OnEnKillfocusPldpins()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp201cP5Dlg::OnEnKillfocusPldvolume()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp201cP5Dlg::SetMaskOnCheckBoxes(UINT mask, int idx)
{
	for(int i = 0; i < 5; i++)
	{
...
void CIcrAdp201cP5Dlg::SetMaskOnCheckBoxesJ(UINT mask, int idx)
{
	for(int i = 0; i < 3; i++)
	{
		CButton* pProc = (CButton*)GetDlgItem(idx++);
...
void CIcrAdp201cP5Dlg::SetMaskOnCheckBoxesA(UINT mask, int idx)
{
	for(int i = 0; i < 2; i++)
	{
		CButton* pProc = (CButton*)GetDlgItem(idx++);
...
void CIcrAdp201cP5Dlg::GetMaskOnCheckBoxes(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 5; i++)
	{
...
void CIcrAdp201cP5Dlg::GetMaskOnCheckBoxesJ(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 3; i++)
	{
...
void CIcrAdp201cP5Dlg::GetMaskOnCheckBoxesA(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 2; i++)
	{
...
void CIcrAdp201cP5Dlg::SetPldName() 
{
...
void CIcrAdp201cP5Dlg::OnBnClickedP1()
{
	// TODO: Add your control notification handler code here
}

void CIcrAdp201cP5Dlg::OnBnClickedM8()
{
	// TODO: Add your control notification handler code here
}
