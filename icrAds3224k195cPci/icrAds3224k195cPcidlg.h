...
class CIcrAds3224k195cPciDlg : public CDialog
{
	DECLARE_DYNAMIC(CIcrAds3224k195cPciDlg)

public:
	CIcrAds3224k195cPciDlg(CWnd* pParent = NULL);   // standard constructor
	virtual ~CIcrAds3224k195cPciDlg();
