// IcrAdp101cP7Dlg.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CIcrAdp101cP7Dlg, CDialog)
CIcrAdp101cP7Dlg::CIcrAdp101cP7Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIcrAdp101cP7Dlg::IDD, pParent)
{
	m_BusClock = 100.0;
	m_HostPldCnt = 0;
	m_strPldName = _T("");
...
CIcrAdp101cP7Dlg::~CIcrAdp101cP7Dlg()
{
}

void CIcrAdp101cP7Dlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_X5, m_ctrlX5);
	DDX_Control(pDX, IDC_X6, m_ctrlX6);
}


BEGIN_MESSAGE_MAP(CIcrAdp101cP7Dlg, CDialog)
	ON_WM_DESTROY()
...
// CIcrAdp101cP7Dlg message handlers

BOOL CIcrAdp101cP7Dlg::OnInitDialog()
{
	...
	m_ctrlX5.SetCurSel(m_X5);
	m_ctrlX6.SetCurSel(m_X6);
...
BOOL CIcrAdp101cP7Dlg::PreTranslateMessage(MSG* pMsg)
{
...
void CIcrAdp101cP7Dlg::OnDestroy()
{
	CDialog::OnDestroy();
	...
	m_X5 = m_ctrlX5.GetCurSel();
	m_X6 = m_ctrlX6.GetCurSel();
...
void CIcrAdp101cP7Dlg::OnCbnSelchangePldrate()
{
...
void CIcrAdp101cP7Dlg::OnCbnSelchangePldtype()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
//void CIcrAdp101cP7Dlg::OnEnKillfocusPldnum()
//{
//	// TODO: Add your control notification handler code here
//}

void CIcrAdp101cP7Dlg::OnEnKillfocusPldpins()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101cP7Dlg::OnEnKillfocusPldvolume()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101cP7Dlg::SetMaskOnCheckBoxes(UINT mask, int idx)
{
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101cP7Dlg::GetMaskOnCheckBoxes(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101cP7Dlg::SetPldName() 
{
...
void CIcrAdp101cP7Dlg::OnBnClickedP1()
{
	// TODO: Add your control notification handler code here
}
