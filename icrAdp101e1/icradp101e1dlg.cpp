// IcrAdp101E1Dlg.cpp : implementation file
//
...
// CIcrAdp101E1Dlg dialog

IMPLEMENT_DYNAMIC(CIcrAdp101E1Dlg, CDialog)
CIcrAdp101E1Dlg::CIcrAdp101E1Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIcrAdp101E1Dlg::IDD, pParent)
{
	m_BusClock = 100.0;
	m_HostPldCnt = 0;
	m_strPldName = _T("");
...
CIcrAdp101E1Dlg::~CIcrAdp101E1Dlg()
{
}

void CIcrAdp101E1Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CIcrAdp101E1Dlg, CDialog)
	ON_WM_DESTROY()
...
// CIcrAdp101E1Dlg message handlers

BOOL CIcrAdp101E1Dlg::OnInitDialog()
{
...
BOOL CIcrAdp101E1Dlg::PreTranslateMessage(MSG* pMsg)
{
...
void CIcrAdp101E1Dlg::OnDestroy()
{
	CDialog::OnDestroy();
...
void CIcrAdp101E1Dlg::OnCbnSelchangePldrate()
{
...
void CIcrAdp101E1Dlg::OnCbnSelchangePldtype()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
//void CIcrAdp101E1Dlg::OnEnKillfocusPldnum()
//{
//	// TODO: Add your control notification handler code here
//}

void CIcrAdp101E1Dlg::OnEnKillfocusPldpins()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101E1Dlg::OnEnKillfocusPldvolume()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101E1Dlg::SetMaskOnCheckBoxes(UINT mask, int idx)
{
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101E1Dlg::GetMaskOnCheckBoxes(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101E1Dlg::SetPldName() 
{
...
void CIcrAdp101E1Dlg::OnBnClickedP1()
{
	// TODO: Add your control notification handler code here
}
