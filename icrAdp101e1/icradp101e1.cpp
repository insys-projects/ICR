// IcrAdp101E1.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include "IcrAdp101E1App.h"    
...
#include "IcrAdp101E1.h"

// инициализация конфигурационных структур
ICR_CfgAdp101E1 m_Adp101E1Cfg = { 
	Adp101E1_CFG_TAG, 
	12, 
	1, 
	300, 
...
BEGIN_MESSAGE_MAP(CIcrAdp101E1App, CWinApp)
END_MESSAGE_MAP()


// CIcrAdp101E1App construction

CIcrAdp101E1App::CIcrAdp101E1App()
{
...
// The one and only CIcrAdp101E1App object

CIcrAdp101E1App theApp;


// CIcrAdp101E1App initialization

BOOL CIcrAdp101E1App::InitInstance()
{
...
BASEMOD_API void __stdcall BASEMOD_GetInfo(int* pNumDev, PBASEMOD_INFO pDevInfo)
{
	...
	{
	case 0:
		lstrcpy(pDevInfo->sName, _T("ADP101E1"));
		pDevInfo->dType = ADP101E1;
		break;
	default:
		*pNumDev = -1;
		return;
...
BASEMOD_API int __stdcall BASEMOD_SetProperty(PBASEMOD_INFO pDeviceInfo)
{
	...
	do
	{
		...
		case Adp101E1_CFG_TAG:
			{
				PICR_CfgAdp101E1 pDspCfg = (PICR_CfgAdp101E1)pCurCfgMem;
				m_Adp101E1Cfg.wTag = pDspCfg->wTag;
				m_Adp101E1Cfg.wSize = pDspCfg->wSize;
				m_Adp101E1Cfg.bAdmIfCnt = pDspCfg->bAdmIfCnt;
				m_Adp101E1Cfg.wMaxCpuClock = pDspCfg->wMaxCpuClock;
				m_Adp101E1Cfg.dBusClock = pDspCfg->dBusClock;
				m_Adp101E1Cfg.dSizeOfSDRAM = pDspCfg->dSizeOfSDRAM;
				m_Adp101E1Cfg.bHostPldCnt = pDspCfg->bHostPldCnt;
//				m_Adp101E1Cfg.wSDRCON = pDspCfg->wSDRCON;
				pDeviceInfo->bAdmIfCnt = pDspCfg->bAdmIfCnt;
				size = sizeof(ICR_CfgAdp101E1);
				RealCfgSize += size;
				break;
			}
		default: 
...
BASEMOD_API int __stdcall BASEMOD_GetProperty(PBASEMOD_INFO pDeviceInfo)
{
	...
	m_Adp101E1Cfg.bAdmIfCnt = pDeviceInfo->bAdmIfCnt;

	PICR_CfgAdp101E1 pDspCfg = (PICR_CfgAdp101E1)pCurCfgMem;
	pDspCfg->wTag = Adp101E1_CFG_TAG;
	pDspCfg->wSize = sizeof(ICR_CfgAdp101E1) - 4;
	pDspCfg->bAdmIfCnt = m_Adp101E1Cfg.bAdmIfCnt;
	pDspCfg->wMaxCpuClock = m_Adp101E1Cfg.wMaxCpuClock;
	pDspCfg->dBusClock = m_Adp101E1Cfg.dBusClock;
	pDspCfg->dSizeOfSDRAM = m_Adp101E1Cfg.dSizeOfSDRAM;
	pDspCfg->bHostPldCnt = m_Adp101E1Cfg.bHostPldCnt;
	//pDspCfg->wSDRCON = m_Adp101E1Cfg.wSDRCON;

	pCurCfgMem = (PUSHORT)((PUCHAR)pCurCfgMem + sizeof(ICR_CfgAdp101E1));
	if(pCurCfgMem >= pEndCfgMem)
		return 1;
...
//	dlg.baseInfo.bAdmIfCnt = pDeviceInfo->bAdmIfCnt;
	...
	dlg.m_MaxCpuClock = m_Adp101E1Cfg.wMaxCpuClock;
	dlg.m_BusClock = m_Adp101E1Cfg.dBusClock / 1000000.;
	dlg.m_SdramSize = m_Adp101E1Cfg.dSizeOfSDRAM;
	dlg.m_HostPldCnt = m_Adp101E1Cfg.bHostPldCnt;
//	dlg.m_DioPldCnt = m_Adp101E1Cfg.bDioPldCnt;
//	dlg.m_SDRCON = m_Adp101E1Cfg.wSDRCON;
//	dlg.m_TypeOfLinks = m_Adp101E1Cfg.bTypeOfLinks;
...
*/
	...
	if (nResponse == IDOK)
	{
		...
		//  dismissed with OK
		m_Adp101E1Cfg.wMaxCpuClock = dlg.m_MaxCpuClock;
		m_Adp101E1Cfg.dBusClock = DWORD(dlg.m_BusClock * 1000000.);
		m_Adp101E1Cfg.dSizeOfSDRAM = dlg.m_SdramSize;
		m_Adp101E1Cfg.bHostPldCnt = dlg.m_HostPldCnt;
//		m_Adp101E1Cfg.bDioPldCnt = dlg.m_DioPldCnt;
		//m_Adp101E1Cfg.wSDRCON = dlg.m_SDRCON;
//		m_Adp101E1Cfg.bTypeOfLinks = dlg.m_TypeOfLinks;
