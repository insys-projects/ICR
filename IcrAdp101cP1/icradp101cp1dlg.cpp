// IcrAdp101cP1Dlg.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CIcrAdp101cP1Dlg, CDialog)
CIcrAdp101cP1Dlg::CIcrAdp101cP1Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIcrAdp101cP1Dlg::IDD, pParent)
{
	m_BusClock = 100.0;
	m_HostPldCnt = 0;
	m_strPldName = _T("");
...
CIcrAdp101cP1Dlg::~CIcrAdp101cP1Dlg()
{
}

void CIcrAdp101cP1Dlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CIcrAdp101cP1Dlg, CDialog)
	ON_WM_DESTROY()
...
// CIcrAdp101cP1Dlg message handlers

BOOL CIcrAdp101cP1Dlg::OnInitDialog()
{
...
BOOL CIcrAdp101cP1Dlg::PreTranslateMessage(MSG* pMsg)
{
...
void CIcrAdp101cP1Dlg::OnDestroy()
{
	CDialog::OnDestroy();
...
void CIcrAdp101cP1Dlg::OnCbnSelchangePldrate()
{
...
void CIcrAdp101cP1Dlg::OnCbnSelchangePldtype()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
//void CIcrAdp101cP1Dlg::OnEnKillfocusPldnum()
//{
//	// TODO: Add your control notification handler code here
//}

void CIcrAdp101cP1Dlg::OnEnKillfocusPldpins()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101cP1Dlg::OnEnKillfocusPldvolume()
{
	// TODO: Add your control notification handler code here
	UpdateData(TRUE); // from window to variable
	SetPldName();
...
void CIcrAdp101cP1Dlg::SetMaskOnCheckBoxes(UINT mask, int idx)
{
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101cP1Dlg::GetMaskOnCheckBoxes(UINT& mask, int idx)
{
	mask = 0;
	for(int i = 0; i < 7; i++)
	{
...
void CIcrAdp101cP1Dlg::SetPldName() 
{
...
void CIcrAdp101cP1Dlg::OnBnClickedP1()
{
	// TODO: Add your control notification handler code here
}
