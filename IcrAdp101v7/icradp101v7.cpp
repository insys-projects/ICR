// IcrAdp101v7.cpp : Defines the initialization routines for the DLL.
//
...
BEGIN_MESSAGE_MAP(CIcrAdp101v7App, CWinApp)
END_MESSAGE_MAP()


// CIcrAdp101v7App construction

CIcrAdp101v7App::CIcrAdp101v7App()
{
...
// The one and only CIcrAdp101v7App object

CIcrAdp101v7App theApp;


// CIcrAdp101v7App initialization

BOOL CIcrAdp101v7App::InitInstance()
{
...
BASEMOD_API void __stdcall BASEMOD_GetInfo(int* pNumDev, PBASEMOD_INFO pDevInfo)
{
	...
	{
	case 0:
		lstrcpy(pDevInfo->sName, _T("ADP101V7"));
		pDevInfo->dType = ADP101V7;
		break;
	default:
		*pNumDev = -1;
		return;
...
BASEMOD_API int __stdcall BASEMOD_SetProperty(PBASEMOD_INFO pDeviceInfo)
{
	...
	do
	{
		...
		case Adp101v7_CFG_TAG:
			{
				PICR_CfgAdp101v7 pDspCfg = (PICR_CfgAdp101v7)pCurCfgMem;
				m_Adp101v7Cfg.wTag = pDspCfg->wTag;
				m_Adp101v7Cfg.wSize = pDspCfg->wSize;
				m_Adp101v7Cfg.bAdmIfCnt = pDspCfg->bAdmIfCnt;
				m_Adp101v7Cfg.wMaxCpuClock = pDspCfg->wMaxCpuClock;
				m_Adp101v7Cfg.dBusClock = pDspCfg->dBusClock;
				m_Adp101v7Cfg.dSizeOfSDRAM = pDspCfg->dSizeOfSDRAM;
				m_Adp101v7Cfg.bHostPldCnt = pDspCfg->bHostPldCnt;
				m_Adp101v7Cfg.wSDRCON = pDspCfg->wSDRCON;
				m_Adp101v7Cfg.bTypeOfLinks = pDspCfg->bTypeOfLinks;
				m_Adp101v7Cfg.wCpuMask = pDspCfg->wCpuMask;
				m_Adp101v7Cfg.wSdramMask = pDspCfg->wSdramMask;
				pDeviceInfo->bAdmIfCnt = pDspCfg->bAdmIfCnt;
				size = sizeof(ICR_CfgAdp101v7);
				RealCfgSize += size;
				break;
			}
		default: 
...
BASEMOD_API int __stdcall BASEMOD_GetProperty(PBASEMOD_INFO pDeviceInfo)
{
	...
	m_Adp101v7Cfg.bAdmIfCnt = pDeviceInfo->bAdmIfCnt;

	PICR_CfgAdp101v7 pDspCfg = (PICR_CfgAdp101v7)pCurCfgMem;
	pDspCfg->wTag = Adp101v7_CFG_TAG;
	pDspCfg->wSize = sizeof(ICR_CfgAdp101v7) - 4;
	pDspCfg->bAdmIfCnt = m_Adp101v7Cfg.bAdmIfCnt;
	pDspCfg->wMaxCpuClock = m_Adp101v7Cfg.wMaxCpuClock;
	pDspCfg->dBusClock = m_Adp101v7Cfg.dBusClock;
	pDspCfg->dSizeOfSDRAM = m_Adp101v7Cfg.dSizeOfSDRAM;
	pDspCfg->bHostPldCnt = m_Adp101v7Cfg.bHostPldCnt;
	pDspCfg->wSDRCON = m_Adp101v7Cfg.wSDRCON;
	pDspCfg->bTypeOfLinks = m_Adp101v7Cfg.bTypeOfLinks;
	pDspCfg->wCpuMask = m_Adp101v7Cfg.wCpuMask;
	pDspCfg->wSdramMask = m_Adp101v7Cfg.wSdramMask;

	pCurCfgMem = (PUSHORT)((PUCHAR)pCurCfgMem + sizeof(ICR_CfgAdp101v7));
	if(pCurCfgMem >= pEndCfgMem)
		return 1;
...
//	dlg.baseInfo.bAdmIfCnt = pDeviceInfo->bAdmIfCnt;
	...
	dlg.m_MaxCpuClock = m_Adp101v7Cfg.wMaxCpuClock;
	dlg.m_BusClock = m_Adp101v7Cfg.dBusClock / 1000000.;
	dlg.m_SdramSize = m_Adp101v7Cfg.dSizeOfSDRAM;
	dlg.m_HostPldCnt = m_Adp101v7Cfg.bHostPldCnt;
	dlg.m_SDRCON = m_Adp101v7Cfg.wSDRCON;
	dlg.m_TypeOfLinks = m_Adp101v7Cfg.bTypeOfLinks;
	dlg.m_CpuMask = m_Adp101v7Cfg.wCpuMask;
	dlg.m_SdramMask = m_Adp101v7Cfg.wSdramMask;
	...
	if (nResponse == IDOK)
	{
		...
		//  dismissed with OK
		m_Adp101v7Cfg.wMaxCpuClock = dlg.m_MaxCpuClock;
		m_Adp101v7Cfg.dBusClock = DWORD(dlg.m_BusClock * 1000000.);
		m_Adp101v7Cfg.dSizeOfSDRAM = dlg.m_SdramSize;
		m_Adp101v7Cfg.bHostPldCnt = dlg.m_HostPldCnt;
		m_Adp101v7Cfg.wSDRCON = dlg.m_SDRCON;
		m_Adp101v7Cfg.bTypeOfLinks = dlg.m_TypeOfLinks;
		m_Adp101v7Cfg.wCpuMask = dlg.m_CpuMask;
		m_Adp101v7Cfg.wSdramMask = dlg.m_SdramMask;
